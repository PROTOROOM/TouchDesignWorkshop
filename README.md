...
세계 각국에서 하나의 소실점을 중심으로 깊이 있게 탐구하고 모색하는 사람들, 그 중 테크놀로지를 메타적 매체로 고민하는 국내외의 창작자와 기획자, 연구자들을 초대하고 그들의 이야기를 듣고 함께 생각하는 프로젝트입니다. [ PROTOROOM Research : Egg ] 는 렉쳐+워크숍+담론의 형식을 통해 참여자들이 각자의 관심 주제와 연결하여 새로운 인사이트를 찾아보고 서로 나눔으로써 그 다음 지점에 대해 생각하는 계기를 만들려고 합니다.
